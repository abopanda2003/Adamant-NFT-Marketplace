...
import {nftmarketaddress, nftaddress,backendurl} from '../../config';
...
class AdminPage extends Component {
    ...
    addWhiteList = async() => {
        ...
        // let transaction = await contract.addCollectionToWhitelist(this.state.accountAddress, indexes);
        // await transaction.wait();
    }
    ...
    onUploadFile = async() => {
        ...
        let wallets = await axios.post(`${backendurl}/load`, formData);
        console.log(wallets);
    }
